...
export const TILE_STYLE="lg:w-[17px] md:x-[15px] xs:w-[8px] w-[7px] lg:h-[17px] md:h-[15px] xs:h-[8px] h-[7px] border-t border-r border-sky-200";
export const TRAVERSED_TILE_STYLE= TILE_STYLE+"bg-cayn-400";
...
export const MAZES:MazeSelectType[]=[
    ...
    {name:"Recursion Division", value:"RECURSIVE_DIVISION"},
];
